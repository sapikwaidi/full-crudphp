...
<head>
    ...
    <!-- JQVMap -->
    <!-- <link rel="style sheet" href="assets-template/plugins/jqvmap/jqvmap.min.css"> -->
    <!-- Theme style -->
...
<div class="wrapper">
    ...
    <aside class="main-sidebar sidebar-dark-primary elevation-4">
        ...
        <a href="index.php" class="brand-link">
            <img src="assets-template/img/logo_siber.jpg" alt="AdminLTE Logo" class="brand-image img-circle elevation-2" style="opacity: .8">
            <span class="brand-text font-weight-light">SIBER PMJ</span>
        </a>
        ...
        <div class="sidebar">
            ...
            <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                ...
                <div class="info">
                    <a href="#" class="d-block">Hai : <?= $_SESSION['nama']; ?></a>
                </div>
            </div>
